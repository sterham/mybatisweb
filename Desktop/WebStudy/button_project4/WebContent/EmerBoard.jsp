                                    ...
                                    <% for( EmergencySenVO arr : list ) { %>
                                        <tr>
	                                        ...
	                                        <td>
	                                            ...
	                                            <span id="inputContent"><input class="form-control" type="text" id="emac<%=arr.getEmergency_pk()%>" placeholder="조치 내용 입력" value="<%=arr.getEmergency_action()%>"></span> 
                                            </td>
                                            <!-- 4. 조치내용 작성하기 버튼 -->
                                            <td>
	                                            <div id = "box"> 
	                                            	<!-- 조치내용 작성 후 완료 버튼을 누르면 이미지로 작성했다는 사실을 알려줘야 하므로 (빨강 -> 파랑) button에 onclick을 걸어줘서 이미지 변경해주기 -->
	                                            	<input type="button"  value="작성하기"  class="btn btn-warning btn-sm" onclick="changeImg(<%=arr.getEmergency_pk()%>)" >
	                                            </div>  
                                            </td>
                                            <!-- 5. 조치 시간 -->
                                            <td><%=arr.getEmergency_action_date() %></td>
                ...
                <script>  
                  function changeImg(pk){
                      ...
                      $.ajax({ 
                    	  ...
                    	  type : "post",
                    	  // 긴급호출 pk가 일치하는 데이터에 조치내용인 action 값을 넘겨주기
